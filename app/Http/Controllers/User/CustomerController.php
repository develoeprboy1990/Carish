...
class CustomerController extends Controller
{
        ...
        if (request()->ajax()) {
            ...
            if ($responseKeys["success"]) {
                ...
                if (isset($configData['ERROR']['CODE']) &&  $configData['ERROR']['CODE'] == '006') {*/
                    ...
                    $finalAaary['message'] = Lang::get('ads.car_not_found');
                /*} else {
                ...
                $finalAaary['message'] = Lang::get('common.captcha_confirm');
                return response()->json($finalAaary);
            }
    ...
    public function getMakersModels()
    {
        if (request()->ajax()) {
            ...
            $html = '<div class="col-md-3 col-sm-12 car-info-list-col make-list-col car-list-active"  >
                        <h6 class="post-ad-modal-title d-flex align-items-center mb-4"><em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em> ' . Lang::get('common.make') . '</h6>
            ...
            foreach ($grouped_models as $keys => $models_array) {
                $html .= '
                    <div class="col-md-3 col-sm-12 car-info-list-col modal-list-col models_for_' . $keys . '" style="display: none">
                        <h6 class="post-ad-modal-title d-flex align-items-center mb-4"><em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em> ' . Lang::get('common.model') . '</h6>
    ...
    {
        $html = '<h6 class="post-ad-modal-title d-flex align-items-center mb-4"><em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em> ' . Lang::get('common.version') . '</h6>
                        <div class="post-modal-list">
        ...
        if (request()->ajax()) {
            ...
            if (!$versions->isEmpty()) {
                ...
                $html .= '<li><a href="javascript:void(0)"><strong> ' . Lang::get('common.no_data_exists_in_this_year') . '</strong></a></li>';
            } // END OF ELSE
    ...
    public function filterAds(Request $request)
    {
        ...
        if ($ads->count() > 0) {
            foreach ($ads as $ad) {
                ...
                $html_string .= '</figure>
                  <div class="col-lg-9 col-sm-8 col-8 pl-md-0 pl-sm-3 pl-0 pr-0 ads-listing-text">
                      ...
                      <p class="ads-views mb-0"><em class="fa fa-eye"></em> ' . @$ad->views . ' ' . __('ads.views') . '</p>';
    
                if ($ad->status == 0) {
                    $html_string .= '<p class="ads-views mb-0" style="color:red;"><strong>' . __('ads.reason') . '</strong> ' . __('ads.waiting_for_admin_approval') . '</p>';
                }
                
                if ($ad->status == 2) {
                    $html_string .= '<p class="ads-views mb-0" style="color:red;"><strong>' . __('ads.reason') . '</strong> ' . @$ad->get_lang_wise_removed_reasons($ad->id) . '</p>';
                }
                if ($ad->status == 3) {
                    $html_string .= '<p class="ads-views mb-0" style="color:red;"><strong>' . __('ads.reason') . '</strong> ' . __('ads.not_approved_by_admin') . '<br>' . $ad->get_reasons($ad->id) . '</p>';
                }
                if ($ad->status == 5) {
                    $html_string .= '<p class="ads-views mb-0" style="color:red;"><strong>' . __('ads.reason') . '</strong> ' . __('ads.waiting_for_payment') . '</p>';
                }
                if ($ad->status == 1) {
                    $html_string .= '<p class="ads-views mb-0" style="color:#005e9b;"><strong>' . __('ads.active_until') . '</strong> ' . ($ad->active_until != null ? $ad->active_until : 'N.A') . '</p>';
                }
                $html_string .= '</div>
                ...
                if ($ad->status == 1 || $ad->status == 3) {
                    $html_string .= '<li class="list-inline-item"><a href="' . route('post.edit', ['id' => $ad->id]) . '" class="border d-inline-block px-sm-3 px-2 py-1 rounded">' . __('ads.edit') . ' <em class=" ml-1 fa fa-pencil"></em></a></li>';
                }
                if ($request->ads_status != 2) {
                    $html_string .= '<li class="list-inline-item"><a href="" class="border d-inline-block px-sm-3 px-2 py-1 rounded remove-ad" data-id="' . $ad->id . '">' . __('ads.remove') . ' <em class="ml-1 fa fa-trash"></em></a></li>';
                }
                if ($ad->status == 2 ) {
                    $html_string .= '<li class="list-inline-item"><a href="' . route('post.removedAdedit', ['id' => $ad->id]) . '" class="border d-inline-block px-sm-3 px-2 py-1 rounded">' . __('ads.reactive') . ' <em class=" ml-1 fa fa-pencil"></em></a></li>';
               
                    $html_string .= '<li class="list-inline-item"><a href="javascript:void(0)" class="border px-sm-3 px-2 py-1 rounded delete-ad"  data-id="' . $ad->id . '">' . __('ads.delete') . ' <em class="ml-1 fa fa-refresh"></em></a></li>';
                }
                $html_string .= '</ul>
                    </div>';
                if ($request->ads_status == 1) {
                    ...
                    if (@$ad->is_featured == 'false' && @$feature_status->count() == 0) {
                        ...
                        ' . __('ads.feature_this_ad') . '
                        </a>';
                    } elseif (@$ad->is_featured == 'true') {
                        $html_string .= '<a href="javascript:void(0)" style="color: #0072BB;"><em class="fa fa-star"></em>
                      <span> ' . __('common.featured_until') . (@$ad->feature_expiry_date !== null ? Carbon::parse(@$ad->feature_expiry_date)->format('d/m/Y H:i:s') : '--') . '</span></a>';
                    } elseif (@$feature_status[0]->status == 0) {
                        $html_string .= '<a href="javascript:void(0)" style="color: #0072BB;"><em class="fa fa-star"></em>
                      <span>' . __('ads.waiting_for_payment') . '</span></a>';
                    }
            ...
            $html_string = '<h2 class="p-4">No Record Found</h2>';
        }
            ...
            foreach ($ads as $ad) {
                ...
                $html_string .= '</div>
                    ...
                    <div class="col-lg-7 col-md-8 col-sm-8 mb-0 editProfile actionbtn ">
                      <ul class="list-unstyled mb-0">';
                if ($ad->status == 1 || $ad->status == 3) {
                    $html_string .= '<li class="list-inline-item"><a href="' . url('user/spare-part-ad/' . @$ad->id) . '" class="border d-inline-block px-sm-3 px-2 py-1 rounded">' . __('ads.edit') . ' <em class=" ml-1 fa fa-pencil"></em></a></li>';
                }
                if ($ad->status != 2) {
                    $html_string .= '<li class="list-inline-item"><a href="" class="border d-inline-block px-sm-3 px-2 py-1 rounded remove-ad" data-id="' . $ad->id . '">' . __('ads.remove') . ' <em class="ml-1 fa fa-trash"></em></a></li>';
                }
                if ($ad->status == 2) {
                    $html_string .= '<li class="list-inline-item"><a href="' . url('user/removed-edit-spare-part-ad/' . @$ad->id) . '" class="border d-inline-block px-sm-3 px-2 py-1 rounded">' . __('ads.reactive') . ' <em class=" ml-1 fa fa-pencil"></em></a></li>';
                ...
                if ($request->ads_status == 1) {
                    ...
                    if (@$ad->is_featured == 'false' && @$feature_status->count() == 0) {
                        ...
                        $html_string .= '<a href="javascript:void(0)" style="color: #0072BB;"><em class="fa fa-star"></em>
                      <span>' . __('ads.featured_until') . ' ' . (@$ad->feature_expiry_date !== null ? Carbon::parse(@$ad->feature_expiry_date)->format('d/m/Y H:i:s') : '--') . '</span></a>';
    ...
    public function filterOfferServices(Request $request)
    {
        ...
        if ($ads->count() > 0) {
            foreach ($ads as $ad) {
                ...
                if ($ad->status == 3) {
                    $html_string .= '<p class="ads-views mb-0" style="color:red;"><strong>' . __('ads.reason') . '</strong> ' . __('ads.not_approved_by_admin') . '</p>';
                }
                if ($ad->status == 1) {
                    $html_string .= '<p class="ads-views mb-0" style="color:#005e9b;"><strong>' . __('ads.active_until') . '</strong> ' . ($ad->active_until != null ? $ad->active_until : 'N.A') . '</p>';
                }
                ...
                if ($request->ads_status == 2) {
                    $html_string .= '<li class="list-inline-item"><a href="' . url('user/removed-edit-service-form/' . @$ad->id) . '" class="border d-inline-block px-sm-3 px-2 py-1 rounded">' . __('ads.reactive') . ' <em class=" ml-1 fa fa-pencil"></em></a></li>';
                ...
                if (@$ad->status == 1) {
                    ...
                    if (@$ad->is_featured == 'false' && @$feature_status->count() == 0) {
                      ...
                      <span>Featured Until ' . (@$ad->feature_expiry_date !== null ? Carbon::parse(@$ad->feature_expiry_date)->format('d/m/Y H:i:s') : '--') . '</span></a>';
                        ...
                        $html_string .= '<a href="javascript:void(0)" style="color: #0072BB;"><em class="fa fa-star"></em>
                      <span>Waiting for payment</span></a>';
                    }
    ...
    public function getAdToFeature(Request $request)
    {
        ...
        if ($ad->is_featured == 'true') {
            $html_string .= '<span class="featuredlabel bgcolor2 font-weight-semibold pb-1 pl-2 pr-2 pt-1 text-uppercase text-white d-inline-block mt-2">' . __('search.featured') . '
                    </span>';
        }
        ...
        if ($ad->neg) {
            $html_string .= __('common.negotiable');
        }
        $html_string .= '</p></div>
        ...
        $html_string .= '<a href="javascript:void(0)" title="' . $ad->poster_phone . '" class="btn contactbtn themebtn3" style="font-size: 12px;font-weight: 200;padding: 5px 5px;"><em class="fa fa-phone"></em> ' . __('search.show_phone_no') . '</a>
                    </div>
                  </div>
                </div>
              </div>
        ...
        if ($credit > 0) {
            $html_string .= '<div style="display:block;padding-left: 20px;margin-top: 20px"><input type="checkbox" name="use_balance" class="use_balance"><span class="ml-2">' . Lang::get("common.use_my_account_balance") . '</span>';
        }
        return response()->json(['html' => $html_string]);
    }
    ...
    public function getMyPayments(Request $request)
    {
        ...
        return Datatables::of($accounts)
            ...
            ->addColumn('status', function ($item) {
                if ($item->status == 0)
                    $html_string = Lang::get('ads.Pending');
                else if ($item->status == 1)
                    $html_string = Lang::get('common.paid');
                else if ($item->status == 2)
                    $html_string = Lang::get('common.not_paid');
                return $html_string;
            })
