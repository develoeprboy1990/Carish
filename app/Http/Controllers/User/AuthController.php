...
/*   public function redirectToProvider()
  ...
  public function verifyCustomerContact(Request $request)
  {
        ...
        if (request()->ajax()) {
            ...
            $message = "Your CARISH verification code is ".$four_digit.", which is valid for 60 seconds.";
            ...
            "dst=".$dst."&src=9233393880&dr=1&type=0&user=carishtest&password=Qzxf84D&msg=".$message.""); 
