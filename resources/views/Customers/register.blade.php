@extends('layouts.app')
@section('title') {{ __('header.sing_up') }} @endsection
@push('styles')
<style type="text/css">
     label.error {
    color: red;
  ...
  <div class="row">
    <div class="col-lg-6 mx-auto col-12 sign-in-col sign-up-col">
      <div class="signInbg box-shadow bg-white p-md-5 p-sm-4 p-3 pt-4 rounded">
        <h1 class="mb-4 pb-md-2  themecolor">{{ __('common.sign_up_to_carish') }}</h1>
        <!-- Nav tabs -->
        <ul class="mx-md-n5 mx-sm-n4 mx-n3 nav nav-tabs sign-up-tabs nav-justified  mb-5">
          <li class="nav-item">
            @if(session::has('msg'))
            <a class="font-weight-semibold nav-link rounded-0" data-toggle="tab" href="#Individual">{{ __('common.individual') }}</a>
            @else
            <a class="font-weight-semibold nav-link rounded-0 active" data-toggle="tab" href="#Individual">{{ __('common.individual') }}</a> 
            @endif
          </li>
          <li class="nav-item">
            @if(session::has('msg'))
            <a class="font-weight-semibold nav-link rounded-0 active" data-toggle="tab" href="#company">{{ __('common.business') }}</a>
            @else
            <a class="font-weight-semibold nav-link rounded-0" data-toggle="tab" href="#company">{{ __('common.business') }}</a> 
            @endif
          </li>
        </ul>
        <!-- Tab panes -->
        ...
        <div class="tab-pane" id="Individual">
          ...
          <form class="" action="" method="POST" id="myForm">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                    <em class="fa fa-user text-center new_icon" title="{{__('profile.full_name')}}"></em>                
                  </div>
                  <div class="col-11">
                    <input type="text" class="form-control border-0 mr-3" placeholder="{{__('profile.full_name')}}" id="customer_firstname" name="full_name" value="" pattern="[a-zA-Z]+" title="Full Name must contain only alphabets and spaces">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                     <em class="fa fa-envelope text-center new_icon" title="{{__('ads.email')}}"></em>
                  </div>
                  <div class="col-11">
                    <input class="form-control border-0" type="email" id="customer_email_address" placeholder="{{__('ads.email')}}"  name="customer_email_address" value="{{ old('customer_email_address') }}" required="true">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  ...
                  <div class="col-2">
                    ...
                    <div class="col-5">
                      <input type="number" class="form-control border-0 phone-number individual-contact" placeholder="88888888" id="customer_contact" name="customer_contact" value="{{ old('customer_contact') }}" title="Phone number must contain only numbers" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==8) return false;">
                  ...
                  <div class="col-4">
                    <input type="button" class="btn rounded-0 btn-block" id="contact-verify" value="{{__('common.verify')}}">
                  </div>
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                    <em class="fa fa-key text-center new_icon" title="{{__('ads.password')}}"></em>
                  </div>
                  <div class="col-11">
                    <input class="form-control border-0" type="password" required="" id="customer_password" placeholder="{{__('ads.password')}}" value="{{ old('customer_password') }}"  name="customer_password" pattern=".{8,16}" title="Password must be atleast 8 characters long">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                    <em class="fa fa-key text-center new_icon" title="{{__('passwords.confirm_passwrord')}}"></em>
                  </div>
                  <div class="col-11">
                     <input class="form-control border-0" type="password" id="password_confirmation" placeholder="{{__('passwords.confirm_passwrord')}}" value="{{ old('password_confirmation') }}"  name="password_confirmation">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1">
                    <em class="fa fa-globe text-center new_icon" title="{{__('common.city')}}"></em>
                  </div>
                  <div class="col-11">
              ...
              <div class="row">
                <div class="col-1"></div>
                <div class="col-11">
                   <input type="submit" class="btn rounded-0 btn-block themebtn1 signIn-btn individual" disabled value="{{__('auth.create_account')}}">
                </div>
              </div> 
              <div class="connect-with-other">
              <p class="font-weight-semibold signup-note mb-2">{{__('auth.by_clicking_the_button')}}</p>
              <a target="" href="{{ route('terms-of-service') }}" class="themecolor">{{__('auth.terms_of_use')}}</a>
            </div>   
          </form>
          </div>
          @if(session::has('msg'))
          ...
          @endif
            <form class="" action="" method="POST" id="myForm2">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                     <em class="fa fa-user text-center new_icon" title="{{__('common.company_name')}}"></em>
                  </div>
                  <div class="col-11">
                     <input class="form-control border-0" type="text" id="customer_company"  placeholder="{{__('common.company_name')}}"  name="customer_company" value="{{ old('customer_company') }}">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                    <em class="fa fa-map-marker text-center new_icon" title="{{__('common.address')}}"></em>
                  </div>
                  <div class="col-11">
                     <input class="form-control border-0" type="text" id="customer_address"  placeholder="{{__('common.address')}}"  name="customer_address" value="{{ old('customer_address') }}">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                    <em class="fa fa-registered text-center new_icon" title="{{__('common.registration_number')}}"></em>
                  </div>
                  <div class="col-11">
                    <input class="form-control border-0" type="number" id="customer_registration"  placeholder="{{__('common.registration_number')}}"  name="customer_registration" value="{{ old('customer_registration') }}" pattern=".{8,}" title="{{__('common.registration_must_be_atleast_8_characters_long')}}">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                     <em class="fa fa-file-text text-center new_icon" title="{{__('common.vat_number')}}"></em>
                  </div>
                  <div class="col-11">
                    <input class="form-control border-0" type="text" id="customer_vat"  placeholder="{{__('common.vat_number')}}"  name="customer_vat" value="{{ old('customer_vat') }}" pattern="[A-za-z]{2}[0-9]{9}" title="{{__('common.vat_number_must_be_2_alphabets_followed_by_9_digits')}}">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
                   <em class="fa fa-phone text-center new_icon" title="{{__('common.phone_number')}}"></em>
                  </div>
                  <div class="col-11">
                     <input type="number" class="form-control border-0 phone-number" placeholder="5943188" id="customer_contact" name="customer_contact" value="{{ old('customer_contact') }}" pattern="[0-9]+" title="{{__('common.phone_number_must_contain_only_numbers_and_spaces')}}">
                      @if ($errors->has('customer_contact'))
                      <span class="help-block">
                      <strong>{{ $errors->first('customer_contact') }}</strong>
                      </span>
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  ...
                  <div class="col-11">
                    <input class="form-control border-0" type="password" required="" id="customer_password" placeholder="{{__('ads.password')}}" value="{{ old('customer_password') }}"  name="customer_password" pattern=".{8,16}" title="{{__('ads.password_must_be_atleast_8_characters_long')}}">
              ...
              <div class="row">
                <div class="col-1"></div>
                <div class="col-11">
                  <input type="submit" class="btn rounded-0 btn-block themebtn1 signIn-btn" value="{{__('auth.create_account')}}">
                </div>
              </div>
              <div class="connect-with-other">
                <p class="font-weight-semibold signup-note mb-2">{{__('auth.by_clicking_the_button')}}</p>
...
$(document).ready(function(){
  ...
  customer_email_address: "{{__('common.please_enter_valid_email')}}",
  customer_contact: "{{__('common.please_enter_phone_number')}}",
  customer_password: "{{__('common.please_enter_password')}}",
  password_confirmation: "{{__('common.please_reenter_password')}}",
  customer_company: "{{__('common.please_enter_company_name')}}",
  customer_address: "{{__('common.please_enter_address')}}"
  }
  }); 
