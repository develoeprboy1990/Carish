          ...
          <div class="row">
            ...
            <div class="col-12 mt-4 mt-lg-5 pt-3 pt-lg-0">
              <div class="bg-sect p-md-4 p-3 pl-xl-5 pr-xl-5 newtags-form border bgdarklight f-size">
                <h3 class="font-weight-bold tagpagetitle themecolor">{{__('common.suggest_new_form')}}</h3>
                <p>{{__('common.want_to_suggest_new..')}}</p>
                <form method="POST" action="{{route('tag-suggestion')}}">
                  ...
                  <div class="form-row mt-md-4">
                    <div class="col-12 col-lg-5 col-sm-6 form-group mb-md-4">
                      <label class="font-weight-semibold">{{__('common.new_tag')}}</label>
                      <input type="text" class="form-control" name="title" placeholder="{{__('common.your_tag_title_required')}}" required="required">
                    </div>
                    <div class="col-lg-5 col-sm-6 col-12 form-group mb-md-4">
                      <label class="font-weight-semibold">{{__('common.category')}}</label>
                      <select class="form-control" name="category" required="required">
                        <option value="">{{__('common.select_category')}}</option>
                        <option value="{{__('ads.car_tags')}}">{{__('ads.car_tags')}}</option>
                        <option value="{{__('common.dealer_tags')}}">{{__('common.dealer_tags')}}</option>
                      </select>
                    </div>
                    <div class="col-lg-5 col-sm-6 col-12 form-group mb-md-4">
                      <label class="font-weight-semibold">{{__('common.description')}}</label>
                      <input type="text" class="form-control" name="description" placeholder="{{__('common.your_tag_description')}}" required="required">
                    </div>
                    <div class="align-items-end col-12 col-lg-5 col-sm-6 d-flex form-group mb-md-4">
                      <input type="submit" class="bgcolor2 btn tagsubmit w-100" value="{{__('home.submit')}}">
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="col-12">
              <div class="align-items-center col-lg-9 d-sm-flex justify-content-around ml-auto mr-auto mt-4 mt-md-5 pl-0 postAdRow pr-0 pt-2 pt-sm-3">
                ...
                <div class="sellCarBtn">
                  <a href="{{url('user/post-ad')}}" class="btn themebtn1">{{__('search.sell_your_car')}}</a>
                </div>
              </div>
            </div>
          </div>
