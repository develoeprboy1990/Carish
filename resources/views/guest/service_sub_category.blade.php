@extends('layouts.app')
@section('title') {{ __('header.offer_service_search') }} @endsection
@php
  $subCatId =0;
...
@endphp
        ...
        <div class="container">
              ...
              <div class="bg-white border p-md-4 p-3">
                <nav aria-label="breadcrumb" class="breadcrumb-menu" id="breadcrumb">
                  <ol class="breadcrumb"> 
                    ...
                    <li class="breadcrumb-item"><a target="" href="{{route('allservices')}}">{{__('home.services')}}</a></li>
                    @if(empty($sub->title))
               ...
               <div class="col-12 col-md-9 col-lg-9 col-sm-12 mb-4 mt-3">
                 <div class=" overflow-hidden pt-0" style="border: 1px solid #eee;">
                   ...
                   <div class="col-6">
                      <h6 class="post-ad-modal-title d-flex align-items-center" class="post-ad-modal-title" style="height: 70px;font-size: 100%"><!-- <em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em> --> {{__('common.sub_category')}}</h6>
                    </div>
                    <div class="col-6">
                      <h6 class="post-ad-modal-title d-flex align-items-center detail_class" class="post-ad-modal-title" style="height: 70px;font-size: 100%"><!-- <em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em> --> {{__('common.details')}}</h6>
                    </div>
          ...
          <div class="row mt-md-5 mt-4">
            ...
            <div class="search-by-filter">
              <h6 class="sidebar-sect-title d-flex justify-content-between mb-0 pb-3 pl-4 pr-4 pt-3 sidebar-title " data-toggle="collapse" data-target="#searchbyreasult" aria-expanded="false" aria-controls="searchbyreasult">{{__('search.show_results_by')}}: <em class="fa fa-chevron-circle-right d-lg-none sidebar-collpse-icon" data-toggle="collapse" data-target="#searchbyreasult" aria-expanded="false" aria-controls="searchbyreasult"></em></h6>

              <div class="search-filter collapse d-lg-block" id="searchbyreasult">
              <h6 class=" sidebar-title mb-0  pt-3 pb-3 pl-4 pr-4"><img src="{{url('public/assets/img/rIcon-search-filter.png')}}" alt="carish used cars for sale in estonia" class="img-fluid mr-2"> {{__('common.search_filter')}} </h6>
            ...
            <div class="search-by-name">
              <h6 class="sidebar-sect-title d-flex justify-content-between mb-0 pb-3 pl-4 pr-4 pt-3 sidebar-title " data-toggle="collapse" data-target="#searchbyname" aria-expanded="false" aria-controls="searchbyname">{{__('search.search_by_title')}}: <em class="fa fa-chevron-circle-right d-lg-none sidebar-collpse-icon" data-toggle="collapse" data-target="#searchbyname" aria-expanded="false" aria-controls="searchbyname"></em></h6>
  ...
  <h6 class="sidebar-sect-title d-flex justify-content-between mb-0 pb-3 pl-4 pr-4 pt-3 sidebar-title " data-toggle="collapse" data-target="#searchbycity" aria-expanded="false" aria-controls="searchbycity">{{__('common.search_by_city')}} <em class="fa fa-chevron-circle-right d-lg-none sidebar-collpse-icon" data-toggle="collapse" data-target="#searchbycity" aria-expanded="false" aria-controls="searchbycity"></em></h6>
      <div class="collapse d-lg-block bg-white" id="searchbycity">
          <div class="p-4">
            <div class="input-group sidebar-input-group">
              <input type="text" id="cities" class="form-control p-2 pr-2" placeholder="{{__('common.city')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" autocomplete="off">
            ...
            <div class="search-by-name">
              <h6 class="sidebar-sect-title d-flex justify-content-between mb-0 pb-3 pl-4 pr-4 pt-3 sidebar-title " data-toggle="collapse" data-target="#searchbytype" aria-expanded="false" aria-controls="searchbyname">{{__('common.service_type')}}: <em class="fa fa-chevron-circle-right d-lg-none sidebar-collpse-icon" data-toggle="collapse" data-target="#searchbytype" aria-expanded="false" aria-controls="searchbyname"></em></h6>
                    ...
                    <li class="d-flex justify-content-between">
                        <div class="custom-control mr-2 custom-checkbox ">
                          <input type="checkbox" value="featured_true" data-value="featured_true" class="custom-control-input search_check_submit" id="modalCheck1" name="example1"
                           {{$featured_checked}}>
                          <label class="custom-control-label" for="modalCheck1">{{__('search.featured')}}</label>
                        </div> </li>
                      @endif
                      @if($unfeatured)
                      <li class="d-flex justify-content-between">
                        <div class="custom-control mr-2 custom-checkbox ">
                          <input type="checkbox"  value="featured_false" data-value="featured_false"  class="custom-control-input search_check_submit" id="modalCheck2" name="example2" 
                           {{$unfeatured_checked}}>
                          <label class="custom-control-label" for="modalCheck2">{{__('common.unfeatured')}}</label>
                        </div>  </li>
                      @endif
...
<div class="col-12 pt-3 pb-3 mt-3 listingCol bg-white car-listing border">
                     ...
                     <div class="col-lg-9 col-md-9 col-sm-9 col-8 listingCar-descCar">
                        ...
                        <div class="align-items-center row contactRow" style="">
                           ...
                           <div class="align-items-center col-8 col-lg-7 col-md-7 col-sm-8 d-flex justify-content-end text-right pl-md-3 pl-0">
                              ...
                              @php $id = 'heart'; @endphp
                              @endif
                              <a href="javascript:void(0)" class="saveAd saveAdBtn mr-3" data-id="{{$serviceAds->id}}"><em id="{{$id}}{{$serviceAds->id}}" class="fa fa-heart {{$id}}"></em> <span class="save_heart">{{__('search.save')}}</span></a>
                              @else
                              <a target="" href="{{url('user/login')}}" class="saveAd saveAdBtn mr-3" data-id="{{@$serviceAds->id}}"><em id="{{@$id}}{{$serviceAds->id}}" class="fa fa-heart {{@$id}}"></em> <span class="save_heart">{{__('search.save')}}</span></a>
                              @endif
                              <a target="" href="{{url('user/login')}}" class="mr-3" data-id="{{@$serviceAds->id}}"><em class="fa fa-share" style="color: gray"></em> <span class="share_heart">{{__('search.share')}}</span></a>
                              <a href="javascript:void(0)" title="{{@$serviceAds->phone_of_service}}" class="btn contactbtn themebtn3" style="font-size: 12px;font-weight: 200;padding: 5px 5px;"><em class="fa fa-phone"></em> {{__('search.show_phone_no')}}</a>
                           </div>
          ...
          <div class="bg-white col-lg-12 p-4">
            <h2>{{__('common.no_services_founds')}}</h2>
          </div>
          @endif
