      ...
      <div class="col-12 right-content">
        ...
        <div class="row">
          ...
          <div class="listingtab col-lg-9 col-md-8">
            ...
            @php
            $feature_status = App\Models\Customers\CustomerAccount::select('status')->where('ad_id',@$ad->id)->where('type','sparepart')->where('status',0)->where('detail','feature sparepart')->get();
            $sub_category = @$ad->category->parent_id;
            ...
            $caty = ($ad->category->get_category_title()->where('language_id',$activeLanguage['id'])->pluck('title'));
              ...
              <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-sm-9 col-8 listingCar-descCar">
                  <div class="align-items-center d-flex justify-content-between listingCar-title mb-1">
                    <h5 class="font-weight-normal mb-0"><a href="{{url('spare-parts-details/'.@$ad->id)}}" target="">{{@$ad->title}}</a></h5>
                  ...
                  <div class="align-items-center row contactRow " style="">
                    ...
                    <div class="align-items-center col-8 col-lg-7 col-md-7 col-sm-8 d-flex justify-content-end text-right pl-md-3 pl-0">
                      ...
                      @if(Auth::guard('customer')->user())
                      <a data-customer="{{$ad->customer_id}}" data-id="{{$ad->id}}" data-ads_title="{{$ad->title}}" href="javascript:void(0)" class="btn contactbtn themebtn3 show_phone_no send-msg-btn"><em class="fa fa-envelope"></em> {{ __('ads.send_message') }}</a>
                      @else
