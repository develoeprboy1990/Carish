          ...
          <div class="col-xl-10 col-lg-10 col-md-10 mt-md-0 mt-4">
            <div class="align-items-md-center row">
              <div class="col-xl-8 col-lg-7 col-sm-6 pr-lg-3 pr-md-0 user-profile">
                ...
                <p class="mb-0 mb-2 member-from">{{__('profile.member_since')}} @if(!empty($customer->created_at)) {{$customer->created_at->format('M-Y-D')}} @endif</p>
                  ...
                  <div class="align-items-center row contactRow">
                    <div class="col-lg-5 col-md-5 col-sm-4 col-4">
                      <p class="mb-0">
                        ...
                        @endphp
                        {{__('search.updated')}} {{$diff}} {{__('search.days_ago')}}
                      </p>
                    </div>
                    <div class="align-items-center col-8 col-lg-7 col-md-7 col-sm-8 d-flex justify-content-end text-right pl-md-3 pl-0">
                      ...
                      @if(Auth::guard('customer')->user())
                      <a data-customer="{{$serviceAds->customer_id}}" data-id="{{$serviceAds->id}}" data-ads_title="{{@$title !== null ? @$title  : ''}}" href="javascript:void(0)" class="btn contactbtn themebtn3 show_phone_no send-msg-btn" style="font-size: 12px;font-weight: 200;padding: 5px 5px;"><em class="fa fa-envelope"></em> {{ __('ads.send_message') }}</a>
                      @else
                      <a target="" href="{{url('user/login')}}" class="btn contactbtn themebtn3 show_phone_no"><em class="fa fa-envelope"></em> {{ __('ads.send_message') }}</a>
