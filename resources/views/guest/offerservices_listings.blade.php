@extends('layouts.app')
@section('title') {{ __('header.find_services') }} @endsection
@push('styles')
<style type="text/css">
    .expand_success {
        background: #ddd;
...
<div class="internal-page-content mt-4 pb-0 sects-bg">
    <div class="bgcolcor bgcolor1 internal-banner text-white cc-page-banner">
        <div class="container">
            <h3 class="font-weight-semibold text-capitalize mb-1">{{__('common.offer_services_in_estonia')}}</h3>
            ...
            <form class="p-md-2">
                <div class="form-row row">
                    ...
                    <div class="col-5 col-md-3 col-sm-4 form-group mb-0">
                        <input disabled="disabled" type="submit" value="Search" class="btn themebtn3 w-100 pl-3 pr-3 search_check_submit">
                    </div>
                </div>
            </form>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="border border-left-0 col-12 col-md-9 col-sm-8 offered-services-product p-3 p-lg-4">
                                <div class="text-right view-all-offers mb-2">
                                    <a id="view_all_{{$category->slug}}" target="_blank" href="{{url('find-car-services/'.$category->slug)}}" class="f-size font-weight-semibold themecolor view-all-offers-link">{{__('common.view_all')}}</a>
                                </div>
                                    ...
                                    <div class="item">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-12 text-center">
                                                <h5 class="" style="margin-top: 6%;">{{__('search.no_record_found')}}
                                                </h5>
                                            </div>
                                            @endif
