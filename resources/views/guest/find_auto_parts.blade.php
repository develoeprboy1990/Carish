@extends('layouts.app')
@section('title') {{ __('header.find_auto_parts') }} @endsection
@push('styles')
<style type="text/css">
  .expand_success {
    background: #ddd;
...
<div class="internal-page-content mt-4 sects-bg pb-0">
  <div class="bgcolcor bgcolor1 internal-banner text-white cc-page-banner">
    <div class="container">
      <h2 class="font-weight-semibold text-capitalize mb-1">{{__('common.auto_parts_and_car_for_sale')}}</h2>
      <p class="mb-0">{{__('common.your_one_stop')}}</p>
    </div>
  </div>
    ...
    <div class="comp-form-bg bg-white border p-md-4 p-3">
      <div class="form-row row">
        <div class="col-7 col-md-9 col-sm-8 form-group mb-0">
          ...
          <input type="text" id="autoPartSearch" value="" name="" placeholder="{{__('search.search_car_parts_and_accessories')}}" class="form-control" required="true">
          <input type="hidden" id="autopartSelected" class="search_text_submit">
        </div>
        <div class="col-5 col-md-3 col-sm-4 form-group mb-0">
          <input disabled="disabled" type="submit" value="{{__('common.search')}}" class="btn  themebtn3 w-100 pl-3 pr-3 search_check_submit">
        </div>
      </div>
    </div>
    <div class="bg-white border p-md-4 p-3 mt-4">
      <div class="row form-row">
        <div class="col-12 col-md-8 col-sm-7 form-group mb-0 d-flex align-items-center">
          ...
          <p class="f-size1 mb-0">{{__('common.sell_you_mob_quickly')}}</p>
        </div>
        <div class="col-12 col-md-4 col-sm-5 form-group mb-0 mt-3 mt-sm-0 text-sm-right text-center">
          <a class="btn  themebtn2 pl-3 pr-3" href="{{ route('sparepartads') }}">{{__('common.sell_accessories')}}</a>
        </div>
      </div>
    </div>
  </div>
            ...
            <div class="row find_autoparts_sidebar">
              ...
              <div class="border border-left-0 col-12 col-md-9 col-sm-8 offered-services-product p-3 p-lg-4">
                <div class="text-right view-all-offers mb-2">
                  <a target="_blank" id="view_all_{{$service->slug}}" href="{{url('find-autoparts/'.$service->slug)}}" class="f-size font-weight-semibold themecolor view-all-offers-link">{{__('common.view_all')}}</a>
                </div>
                  ...
                  <div class="item">
                    <div class="row">
                      ...
                      <div class="col-lg-12 text-center">
                        <h5 class="" style="margin-top: 6%;">{{__('search.no_record_found')}}</h5>
                      </div>
                      @endif
