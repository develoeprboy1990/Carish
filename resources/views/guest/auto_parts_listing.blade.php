            ...
            <aside class="col-lg-3 col-12 mb-4 mb-lg-0 left-sidebar">
                    ...
                    <div class="card">
                     <div class="card-header pl-4 pr-4" id="heading_make">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_dealer" aria-expanded="false" aria-controls="searchby_dealer">
                           ...
                           <span>{{__('search.search_by_dealer')}} <small class="d-block"></small></span>
                        </a>
                     </div>
                    ...
                    <div class="card">
                     <div class="card-header pl-4 pr-4" id="heading_make">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_name" aria-expanded="false" aria-controls="searchby_name">
                           ...
                           <span>{{__('search.search_by_title')}} <small class="d-block"></small></span>
                        </a>
                     </div>
                    ...
                    <div class="card">
                     <div class="card-header pl-4 pr-4" id="heading_make">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_city" aria-expanded="false" aria-controls="searchby_city">
                           ...
                           <span>{{__('search.location')}} <small class="d-block"> </small></span>
                        </a>
                     </div>
                    ...
                    <div class="card">
                     <div class="card-header pl-4 pr-4" id="heading_make">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_product_code" aria-expanded="false" aria-controls="searchby_product_code">
                           <figure class="text-center mb-0"><i class="fa fa-building"></i></figure>
                           <span>{{__('common.product_code')}} <small class="d-block"></small></span>
                        </a>
                     </div>
                        ...
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" id="product_code" data-value="productcode_"
                                        ...
                                        class="form-control p-2 pr-2 search_text_submit" placeholder="{{__('common.product_code')}}"
                                        aria-label="Recipient's username" aria-describedby="basic-addon2">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                    ...
                    <div class="card">
                     <div class="card-header pl-4 pr-4" id="heading_make">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_condition" aria-expanded="false" aria-controls="searchby_condition">
                           ...
                           <span>{{__('common.condition')}} <small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_condition" class="collapse" aria-labelledby="heading_make" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="{{__('common.condition')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" id="car_makes">
                              <input type="hidden" id="car_make" data-value="mk_" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                  ...
                  <div class="card">
                     <div class="card-header pl-4 pr-4" id="heading40">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby40" aria-expanded="false" aria-controls="searchby40">
                           ...
                           <span>{{__('common.price')}} <small class="d-block"></small></span>
                        </a>
                     </div>
                     @php
                     $maximumPrice = '';
                        ...
                        <div class="card-body">
                           <div class="form-group d-flex mb-0">
                              <span class="align-items-center border d-block d-flex pricerange px-3 py-1" style="width: 100%;">
                                 ...
                                 @endphp
                                 @else
                                 <div class="select-prng">{{__('common.price')}} </div>
               ...
               <div class="card-header pl-4 pr-4" id="heading10">
                  <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby12" aria-expanded="false" aria-controls="searchby12">
                     ...
                     <span>{{__('search.ad_picture')}} <small class="d-block"></small></span>
                  </a>
               </div>
               <div id="searchby12" class="collapse" aria-labelledby="heading12" data-parent="#searchResultFilter">
                  <div class="card-body">
                     <ul class="list-unstyled carselectlist mb-0">
                        <li class="d-flex justify-content-between">
                           <div class="custom-control mr-2 custom-checkbox ">
                              <input type="checkbox" class="custom-control-input search_check_submit_autoparts" id="pictureCheck" value="pic_Ads-With-Pictures" data-value="pic_Ads-With-Pictures" @isset($quey_string_slug['pic']) @if(in_array('Ads-With-Pictures',$quey_string_slug['pic'])) checked="checked" @endif @endisset>
                              <label class="custom-control-label" for="pictureCheck">{{__('search.with_picture')}}</label>
                           </div>
                    ...
                    <div class="card f1 f2">
                     <div class="card-header pl-4 pr-4" id="heading_make">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_make" aria-expanded="false" aria-controls="searchby_make">
                            <figure class="text-center mb-0"><img src="{{url('public/assets/img/rIcon-mileage.png')}}" alt="carish used cars for sale in estonia" class="img-fluid"></figure>
                           <span>{{__('common.make')}} <small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_make" class="collapse" aria-labelledby="heading_make" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="{{__('search.search_by_make')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" id="car_makes">
                              <input type="hidden" id="car_make" data-value="mk_" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           ...
                           <ul class="list-unstyled carselectlist mb-0">
                                 @if(isset($sideBarArray['foundInMake']) && !empty($sideBarArray['foundInMake']))
                                    ...
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="make_{{$foundInMake->id}}"
                                                class="custom-control-input search_check_submit_autoparts"
                                                id="modalCheck{{$foundInMake->id}}" @if(isset($queyStringArray['make'])
                                                && in_array($foundInMake->id,$queyStringArray['make']))
                                            checked="checked" @endif >
                                            <label class="custom-control-label"
                                                for="modalCheck{{$foundInMake->id}}">{{$foundInMake->name}}</label>
                                        </div>
                                        <div><span
                                                class="badge badge-pill border pb-1 pt-1 bgdarklight">{{$foundInMake->totalAdsInCities}}</span>
                                        </div>
                                    </li>
                                    @endforeach
                                    @endif
                     ...
                     <div class="card-header pl-4 pr-4" id="heading_model">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_model" aria-expanded="false" aria-controls="searchby_model">
                          <figure class="text-center mb-0"><img src="{{url('public/assets/img/rIcon-bodystyle.png')}}" alt="carish used cars for sale in estonia" class="img-fluid"></figure>
                           <span>{{__('common.model')}} <small class="d-block"></small></span>
                        </a>
                     </div>
               ...
               <div class="card-header pl-4 pr-4" id="heading11">
                  <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby11" aria-expanded="false" aria-controls="searchby11">
                     ...
                     <span>{{__('search.engine_size')}}<small class="d-block"></small></span>
                  </a>
               </div>
               <div id="searchby11" class="collapse" aria-labelledby="heading11" data-parent="#searchResultFilter">
                  ...
                  <div class="card-body">
                    ...
                    <div class="form-group d-flex mb-0" style="align-items: center;">
                        <span class="mr-2" style="font-size: 14px;color: #aaa;">{{__('common.liter')}}</span>
                        <input type="text" name="engineccFrom" id="engineccFrom" placeholder="{{__('common.from')}}" class="form-control p-1" value="{{@$engineccFrom}}" style="border-radius: 0px;">
                        <input type="text" name="engineccTo" id="engineccTo" placeholder="{{__('common.to')}}" class="form-control p-1 ml-2 mr-2" value="{{@$engineccTo}}" style="border-radius: 0px;">
                     ...
                     <div class="form-group d-flex mb-0" style="align-items: center;text-align: center;">
                        <span style="width: 100%;font-size: 14px;color: #aaa;" class="mt-3 mb-3">{{__('common.or')}}</span>
                     </div>


                     <div class="form-group d-flex mb-0" style="align-items: center;">
                        <span class="mr-2" style="font-size: 14px;color: #aaa;">{{__('common.kw')}}</span>
                        <input type="text" name="powerFrom" id="powerFrom" placeholder="{{__('common.from')}}" class="form-control p-1" value="{{@$powerFrom}}" style="border-radius: 0px;">
                        <input type="text" name="powerTo" id="powerTo" placeholder="{{__('common.to')}}" class="form-control p-1 ml-2 mr-2" value="{{@$powerTo}}" style="border-radius: 0px;">
                        <button type="button" class="fa fa-search themebtn3 search_check_submit" style="font-size: 14px;background-color: white;color: #aaa;border: none;"></button>
                     </div>
                    ...
                    <div class="card f3">
                     <div class="card-header pl-4 pr-4" id="heading_manufacturer_tyre">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_manufacturer_tyre" aria-expanded="false" aria-controls="searchby_manufacturer_tyre">
                           ...
                           <span>{{__('common.manufacturer_tyre')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_manufacturer_tyre" class="collapse" aria-labelledby="heading_manufacturer_tyre" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="{{__('common.manufacturer_tyre')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" id="car_makes">
                              <input type="hidden" id="car_make" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           </div>
                           <ul class="list-unstyled carselectlist mb-0">
                                    ...
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="{{$tyre->id}}" class="custom-control-input search_check_submit_autoparts" @if(old('tyre_manufacturer')==$tyre->id) {{ 'checked' }} @endif >
                                            <label class="custom-control-label" for="">{{$tyre->title}}</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
                                        </div>
                                    </li>
                                    @endforeach
                    ...
                    <div class="card f3">
                     <div class="card-header pl-4 pr-4" id="heading_size">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_size" aria-expanded="false" aria-controls="searchby_size">
                           ...
                           <span>{{__('common.size')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_size" class="collapse" aria-labelledby="heading_size" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="175/65/R14" aria-label="Recipient's username" aria-describedby="basic-addon2" >
                              <input type="hidden" id="car_make" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                    ...
                    <div class="card f3">
                     <div class="card-header pl-4 pr-4" id="heading_type">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_type" aria-expanded="false" aria-controls="searchby_type">
                            <figure class="text-center mb-0"><img src="{{url('public/assets/img/rIcon-mileage.png')}}" alt="carish used cars for sale in estonia" class="img-fluid"></figure>
                           <span>{{__('common.type')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_type" class="collapse" aria-labelledby="heading_type" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="{{__('common.type')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" id="car_makes">
                              <input type="hidden" id="car_make" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           ...
                           <ul class="list-unstyled carselectlist mb-0">
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="summer" class="custom-control-input search_check_submit_autoparts" @if(old('f3_type')=='summer') {{ 'checked' }} @endif >
                                            <label class="custom-control-label" for="">{{__('common.summer')}}</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
                                        </div>
                                    ...
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="winter" class="custom-control-input search_check_submit_autoparts" @if(old('f3_type')=='winter') {{ 'checked' }} @endif >
                                            <label class="custom-control-label" for="">{{__('common.winter')}}</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
                                        </div>
                                    ...
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="all_season" class="custom-control-input search_check_submit_autoparts" @if(old('f3_type')=='all_season') {{ 'checked' }} @endif >
                                            <label class="custom-control-label" for="">{{__('common.all_season')}}</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
                                        </div>
                    ...
                    <div class="card f3">
                     <div class="card-header pl-4 pr-4" id="heading_quantity">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_quantity" aria-expanded="false" aria-controls="searchby_quantity">
                            <figure class="text-center mb-0"><img src="{{url('public/assets/img/rIcon-price.png')}}" alt="carish used cars for sale in estonia" class="img-fluid"></figure>
                           <span>{{__('common.quantity')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_quantity" class="collapse" aria-labelledby="heading_quantity" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="{{__('common.quantity')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" id="f3_quantity">
                              <input type="hidden" id="car_make" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           ...
                           <ul class="list-unstyled carselectlist mb-0">
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="1" class="custom-control-input search_check_submit_autoparts" @if(old('f3_quantity')=='1') {{ 'checked' }} @endif >
                    ...
                    <div class="card f4">
                     <div class="card-header pl-4 pr-4" id="heading_manufacturer_rim">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_manufacturer_rim" aria-expanded="false" aria-controls="searchby_manufacturer_rim">
                            <figure class="text-center mb-0"><img src="{{url('public/assets/img/rIcon-gearbox.png')}}" alt="carish used cars for sale in estonia" class="img-fluid"></figure>
                           <span>{{__('common.manufacturer_rim')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_manufacturer_rim" class="collapse" aria-labelledby="heading_manufacturer_rim" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="{{__('common.manufacturer_rim')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" id="f4_wheel_manufacturer">
                              <input type="hidden" id="car_make" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           ...
                           <ul class="list-unstyled carselectlist mb-0">
                                    ...
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="{{$wheel->id}}" class="custom-control-input search_check_submit_autoparts" @if(old('tyre_manufacturer')==$wheel->id) {{ 'checked' }} @endif >
                                            <label class="custom-control-label" for="">{{$wheel->title}}</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
                                        </div>
                    ...
                    <div class="card f4">
                     <div class="card-header pl-4 pr-4" id="heading_size_inch">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_size_inch" aria-expanded="false" aria-controls="searchby_size_inch">
                            <figure class="text-center mb-0"><img src="{{url('public/assets/img/rIcon-search-filter.png')}}" alt="carish used cars for sale in estonia" class="img-fluid"></figure>
                           <span>{{__('common.size_inch')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_size_inch" class="collapse" aria-labelledby="heading_size_inch" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="14*6.5" aria-label="Recipient's username" aria-describedby="basic-addon2" id="f4_size_inch">
                              <input type="hidden" id="car_make" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                    ...
                    <div class="card f4">
                     <div class="card-header pl-4 pr-4" id="heading_offset_mm">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_offset_mm" aria-expanded="false" aria-controls="searchby_offset_mm">
                           ...
                           <span>{{__('common.offset_mm')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_offset_mm" class="collapse" aria-labelledby="heading_offset_mm" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="14*6.5" aria-label="Recipient's username" aria-describedby="basic-addon2" id="f4_offset_mm">
                              <input type="hidden" id="f4_offset_mm" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           </div>
                    ...
                    <div class="card f4">
                     <div class="card-header pl-4 pr-4" id="heading_style">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_style" aria-expanded="false" aria-controls="searchby_style">
                            <figure class="text-center mb-0"><img src="{{url('public/assets/img/rIcon-bodystyle.png')}}" alt="carish used cars for sale in estonia" class="img-fluid"></figure>
                           <span>{{__('common.style')}} <small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_style" class="collapse" aria-labelledby="heading_style" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="{{__('common.style')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" id="f4_style">
                              <input type="hidden" id="f4_style" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           </div>
                           <ul class="list-unstyled carselectlist mb-0">
                                   <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="" class="custom-control-input search_check_submit_autoparts"  >
                                            <label class="custom-control-label" for="">{{__('common.steel')}}</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
                                        </div>
                                   ...
                                   <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="" class="custom-control-input search_check_submit_autoparts"  >
                                            <label class="custom-control-label" for="">{{__('common.alloy')}}</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
                                        </div>
                                    ...
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="" class="custom-control-input search_check_submit_autoparts"  >
                                            <label class="custom-control-label" for="">{{__('common.chrome')}}</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
                                        </div>
                    ...
                    <div class="card f4">
                     <div class="card-header pl-4 pr-4" id="heading_num_of_holes">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_num_of_holes" aria-expanded="false" aria-controls="searchby_num_of_holes">
                            <figure class="text-center mb-0"><img src="{{url('public/assets/img/rIcon-mileage.png')}}" alt="carish used cars for sale in estonia" class="img-fluid"></figure>
                           <span>{{__('common.num_of_holes')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_num_of_holes" class="collapse" aria-labelledby="heading_num_of_holes" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="4" aria-label="Recipient's username" aria-describedby="basic-addon2" id="f4_num_of_holes">
                              <input type="hidden" id="f4_num_of_holes" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           </div>
                    ...
                    <div class="card f4">
                     <div class="card-header pl-4 pr-4" id="heading_distance_between_holes">
                        <a href="#" class="collapsed align-items-center d-flex" data-toggle="collapse" data-target="#searchby_distance_between_holes" aria-expanded="false" aria-controls="searchby_distance_between_holes">
                           ...
                           <span>{{__('common.distance_between_holes')}}<small class="d-block"></small></span>
                        </a>
                     </div>
                     <div id="searchby_distance_between_holes" class="collapse" aria-labelledby="heading_distance_between_holes" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="100" aria-label="Recipient's username" aria-describedby="basic-addon2" id="f4_distance_between_holes">
                              <input type="hidden" id="f4_distance_between_holes" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           </div>
                   ...
                   {{-- SEARCH BY Quantity --}}        
                    <div class="card f4">
                     ...
                     <div id="searchby_f4_quantity" class="collapse" aria-labelledby="heading_f4_quantity" data-parent="#searchResultFilter">
                        <div class="card-body">
                           <div class="input-group sidebar-input-group mb-3">
                              <input type="text" class="form-control p-2 pr-2" placeholder="{{__('common.quantity')}}" aria-label="Recipient's username" aria-describedby="basic-addon2" id="f4_quantity">
                              <input type="hidden" id="f4_quantity" data-value="" value="" class="search_text_submit">
                              <div class="input-group-append">
                                 <button class="btn fa fa-search pl-2 pr-2 searchIconBtn text-white themebtn2 search_check_submit_autoparts" type="button"></button>
                              </div>
                           </div>
                           <ul class="list-unstyled carselectlist mb-0">
                                    <li class="d-flex justify-content-between">
                                        <div class="custom-control mr-2 custom-checkbox">
                                            <input type="checkbox" data-value="1" class="custom-control-input search_check_submit_autoparts" @if(old('f4_quantity')=='1') {{ 'checked' }} @endif >
                                            <label class="custom-control-label" for="">1</label>
                                        </div>
                                        <div>
                                            <span class="badge badge-pill border pb-1 pt-1 bgdarklight">0</span>
