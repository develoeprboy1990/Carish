...
@endphp
    <div class="container">
        <div class="row">
            <div class="col-md-2">
                <p>{{__('common.advance_search')}}</p>
                <form action="{{url('/advance-search-ads')}}" method="post">
                    {{csrf_field()}}
                    <p>{{__('common.city')}}</p>
                    <select name="city"  class="form-control">
                        <option value="" selected disabled="">{{__('profile.select_city')}}</option>
                    ...
                    <select name="maker" class="form-control" onchange="getModels(this)">
                        <option value="" selected disabled="" >{{__('common.select_make')}}</option>
                    ...
                    <select name="models" disabled id="modelsSelect"  class="form-control">
                        <option value="" selected disabled="">{{__('common.select_model')}}</option>
                    </select>

                    <p>{{__('common.year')}}</p>
                    <select name="year"  class="form-control">
                        <option value="" selected disabled="">{{__('common.select_year')}}</option>
                    ...
                    <p>{{__('common.price')}}</p>
                    <input type="number" class="form-control" name="price_from" placeholder="{{__('common.price_from')}}">
                    <input type="number" class="form-control" name="price_to" placeholder="{{__('common.price_to')}}">

                    <p>{{__('ads.mileage')}} (KM)</p>
                    <input type="number" class="form-control" name="m_from" placeholder="{{__('ads.mileage_from')}}">
                    <input type="number" class="form-control" name="m_to" placeholder="{{__('ads.mileage_to')}}">

                    <p>{{__('ads.color')}}</p>
                    <select name="color"  class="form-control">
                        <option value="" selected disabled="">{{__('ads.select_color')}}</option>
