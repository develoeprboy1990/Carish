        ...
        <div class="bgcolcor bgcolor1 internal-banner text-white cc-page-banner">
          <div class="container">
            <nav aria-label="breadcrumb" class="breadcrumb-menu mb-2">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="javascript:void(0)">{{__('common.home')}}</a></li>
                  <li class="breadcrumb-item"><a href="javascript:void(0)">{{__('compare.cars')}}</a></li>
                  <li class="breadcrumb-item active" aria-current="page">{{__('compare.new_car_comparison')}}</li>
                </ol>
              </nav>
            <h1 class="font-weight-semibold  mb-2">{{__('compare.cars_comparison')}}</h1>
            <p class="mb-0">{{__('compare.confused')}}</p>
          </div>
        </div>
          ...
          <form action="{{ route('comparedetails') }}" method="POST" id="compare_form">
              ...
              <div class="form-row">
                <div class="form-group col-md-4 col-sm-4 col-12">
                  <label class="font-weight-semibold f-size1">{{__('compare.select_car')}}-1</label>
                ...
                <div class="form-group col-md-4 col-sm-4 col-12">
                  <label class="font-weight-semibold f-size1">{{__('compare.select_car')}}-2</label>
                ...
                <div class="align-items-center col-12 d-flex form-group justify-content-between mt-md-4 mt-2 mb-0">
                  <div class="comp-clear">
                    <a href="javascript:void(0)" class="font-weight-semibold themecolor clear_inputs">{{__('home.clear')}}</a>
                  </div>
                  <div class="comp-submit">
                    <input type="submit" value="{{__('home.submit')}}" class="btn  themebtn3">
                  </div>
                </div>
              </div>
              <!-- Modal -->
                ...
                <div class="modal-dialog modal-lg" role="document">
                  <div class="modal-content sects-bg">
                    <div class="modal-header border-bottom-0 pl-md-4 pr-md-4">
                      <h5 class="modal-title">{{__('compare.my_saved_ads')}}</h5>
                    ...
                    <div class="modal-body comp-modal-body pl-md-4 pr-md-4 pb-4">
                      <div class="bg-white">
                         ...
                         <div class="overflow-auto p-4 saved-cars">
                          <p><b>{{__('home.please_login_first_to_see_saved_ads')}} </b> <a href="{{url('user/login')}}" style="color: blue;text-decoration: underline;">{{__('home.click_here_to_login')}}</a></p>
                        @else
