@extends('layouts.app')
@section('title') {{ __('header.welcome') }} @endsection
@push('styles')
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 search-form-col">
                <h1 class="font-weight-semibold">{{ __('home.welcome_to_carish') }}</h1>
                <h2 class="font-weight-semibold pb-4">"{{ __('home.nowfindyourdreamcarin') }}"</h2>
                ...
                <div class="form-row advanceSearch text-center justify-content-end">
                    <div class="col-12 advSearchCol pl-0 overflow-hidden text-center">
                        <a href="javascript:void(0)" class="btn font-weight-normal px-5 text-nowrap advanced_search_btn" data-toggle="modal" data-target="#advanceSearch">{{ __('home.advanced_search') }} <em class="fa fa-angle-right ml-1"></em></a>
                    </div>
                </div>
                <!-- Modal -->
                        ...
                        <div class="modal-content">
                            <form action="{{url('search',['true'])}}" method="get" id="simple_search">
                                <div class="modal-header pb-2 pt-2">
                                    <h5 class="modal-title" id="exampleModalLongTitle">{{ __('home.advanced_search') }}
                                    </h5>
                                ...
                                <div class="modal-body  pl-md-4 pr-md-4 pt-4">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group selectFromCol" style="position: relative;">
                                            <label class="font-weight-semibold">{{ __('home.price') }}</label>
                                            <span class="align-items-center border d-block d-flex pricerange px-3 py-1">
                                                ...
                                                <div class="select-prng">{{__('common.price_range')}}</div>
                                            ...
                                            <div class="pr-dropdown pr-dropdown-cls" style="display: none;position: absolute;top: 70px;width: 96%;">
                                                <div class="d-flex pt-2 pr-2 pl-2" style="background-color: #EAF0FF">
                                                    <input type="text" name="minPrice" id="minPrice" placeholder="{{__('common.min')}}" class="form-control form-control-sm mb-2">
                                                    <span style="line-height: 2.5;" class="pr-2 pl-2">-</span>
                                                    <input type="text" name="maxPrice" id="maxPrice" placeholder="{{__('common.max')}}" class="form-control form-control-sm mb-2">
                                                </div>
                                                <div class="d-flex">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group selectFromCol" style="position: relative;">
                                            ...
                                            <div class="pr-dropdown-mileage pr-dropdown-cls" style="display: none;position: absolute;top: 70px;width: 96%;">
                                                <div class="d-flex pt-2 pr-2 pl-2" style="background-color: #EAF0FF">
                                                    <input type="text" name="fromMillage" id="fromMillage" placeholder="{{__('common.from')}}" class="form-control form-control-sm mb-2">
                                                    <span style="line-height: 2.5;" class="pr-2 pl-2">-</span>
                                                    <input type="text" name="toMillage" id="toMillage" placeholder="{{__('common.to')}}" class="form-control form-control-sm mb-2">
                                                </div>
                                                <div class="d-flex">
                                    ...
                                    <div class="form-row mt-4 pt-sm-2 collapse show" id="moreCollapsedFields">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group">
                                            <label class="font-weight-semibold">{{ __('home.versions') }}</label>
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group">
                                            <label class="font-weight-semibold">{{ __('home.engine_power') }}</label>
                                            <div class="form-row">
                                                <div class="col-lg-6 col-md-6 col-6 pr-0 form-group mb-0 selectFromCol">
                                        ...
                                        <div class="col-12 form-group mb-0">
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group">
                                                <label class="font-weight-semibold">{{ __('home.alltransmissiontypes') }}</label>
                                                <select id="transmission" name="transmission" class="form-control search_selectbox_submit">
                                                    <option value="" disabled="true" selected>
                                                        {{ __('home.alltransmissiontypes') }}
                                                    </option>
                                            ...
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group search_selectbox_submit">
                                                <label class="font-weight-semibold">{{ __('home.all_body_types') }}</label>
                                                <select id="body_type" name="body_type" class="form-control">
                                                    <option value="" disabled="true" selected>
                                                        {{ __('home.all_body_types') }}
                                                    </option>
                                                </select>
                                            </div>
                                            <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group">
                                                <label class="font-weight-semibold">{{ __('ads.color') }}</label>
                                ...
                                <div class="col-12 form-group mb-0">
                                    ...
                                    <div class="form-row">
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group">
                                            <label class="font-weight-semibold">{{ __('home.ad_picture') }}</label>
                                            <select id="picture" name="have_picture" class="form-control search_selectbox_submit">
                                                ...
                                                <option value="pic_Ads-With-Pictures">{{ __('home.with_picture') }}
                                                </option>
                                            </select>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group">
                                            <label class="font-weight-semibold">{{ __('search.seller_type') }}</label>
                                            <select id="ads_type" name="ads_type" class="form-control search_selectbox_submit">
                                                <option value="" disabled="true" selected>{{ __('search.seller_type') }}
                                                </option>
                                                <option value="seller_individual">{{ __('search.individuals') }}
                                                </option>
                                                <option value="seller_business">{{ __('search.dealers') }}</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-4 col-md-4 col-sm-6 col-12 form-group">
                                            <label class="font-weight-semibold">{{ __('search.ad_type') }}</label>
...
<div class="container mt-5 mb-sm-5 d-md-block d-none">
    <div class="row servicesRow text-center">
        <div class="col-sm-4 col-md-4 col-12 pl-xl-4 pr-xl-4 servicesCol mb-4 mb-sm-0">
            ...
            <p>{{ __('home.post_your_car_ad') }} <a target="" href="{{route('faqs')}}" class="themecolor"><u>{{ __('home.for_free') }}</u></a> {{ __('home.in_few_seconds') }} </p>
...
<div class="browse-used-cars pb-4 pt-md-5 pt-4 sects-bg">
    <div class="container">
        <div class="section-title mb-4">
            <h2 class="sectTitle font-weight-semibold mb-0">{{ __('home.browse_used') }}
                <span>{{trans_choice('common.cars', 1)}}</span>
            </h2>
        </div>
        <div class="row b-UsedCars-row">
            <div class="col-12 buCars">
                <ul class="nav nav-tabs buCarTabs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#buCars-tab2">{{ __('common.city') }}</a>
                    </li>
                    <li class="nav-item">
...
<div class="about-us pt-4">
    <div class="container">
        <div class="section-title mb-md-4 pb-1">
            <h4 class="sectTitle font-weight-semibold mb-0">{{ __('common.why')}}
                <span>{{__('common.keywords')}}</span>
            </h4>
        </div>
...
<div class="featured-UsedCars mb-md-5 mt-md-5 mb-4 mt-4 sects-bg">
    <div class="container">
        <div class="section-title d-flex justify-content-between align-items-end">
            <h2 class="sectTitle font-weight-semibold mb-0">{{__('home.featured_used')}}
                <span>{{ __('compare.cars')}}</span>
            </h2>
            <a target="" href="{{route('simple.search')}}/used-cars-for-sale/isf_featured" class="viewall-post themecolor">{{__('home.viewallfeaturedusedcars')}}</a>
        </div>
...
<div class="cars-comparison pb-md-5 pt-md-5 pb-4 pt-4 sects-bg">
    <div class="container">
        <div class="section-title mb-md-4 pb-1">
            <h2 class="sectTitle font-weight-semibold mb-0"><span>{{ __('compare.cars')}}</span>
                {{__('home.comparison')}}
            </h2>
        </div>
        <div class="ml-0 mr-0 row">
                ...
                <form method="post" action="{{route('comparedetails')}}" id="compare_form">
                    ...
                    <div class="d-sm-flex mx-0">
                        <div class="form-group w-100">
                            ...
                            <input type="text" name="" placeholder="{{__('home.car-make-model-version')}}" class="border-dark form-control" id="ads_first_text" autocomplete="off" required>
                        ...
                        <div class="form-group w-100">
                            ...
                            <input type="text" name="" placeholder="{{__('home.car-make-model-version')}}" class="border-dark form-control" id="ads_second_text" autocomplete="off" required>
                    ...
                    <div class="form-row">
                        <div class="align-items-center col-12 d-flex form-group justify-content-between mt-lg-4 mt-2 mb-0">
                            <div class="comp-clear">
                                <a href="javascript:void(0)" class="font-weight-semibold themecolor clear_compare">{{__('home.clear')}}</a>
                            </div>
                            <div class="comp-submit">
                                <input type="submit" value="{{__('home.submit')}}" class="btn text-uppercase themebtn3">
                            </div>
                        </div>
                    </div>
                    <!-- Modal for car1 -->
                                ...
                                <div class="modal-body comp-modal-body pl-md-4 pr-md-4 pb-4">
                                    <div class="bg-white">
                                        ...
                                        <div class="overflow-auto p-4 saved-cars">
                                            <p><b>{{__('home.please_login_first_to_see_saved_ads')}} </b> <a href="{{url('user/login')}}" style="color: blue;text-decoration: underline;">{{__('home.click_here_to_login')}}</a>
                                            </p>
                                            @else
                                        ...
                                        <div class="text-center mt-4  mt-md-5">
                                            <button type="button" class="btn themebtn3" data-dismiss="modal">{{__('home.compare')}}</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="container">
        <div class="align-items-center pl-xl-3 pr-xl-3 row sell-car-row">
            <div class="col-12 col-lg-6 col-md-6 pr-md-0 mb-3 mb-md-0 sell-car-col text-md-right text-center">
                <h2 class="font-weight-semibold mb-0 text-uppercase">{{__('home.looking_to_sell_your_car')}}</h2>
...
<div class="popular-UsedCars pb-md-5 pt-md-5 pb-4 pt-4 sects-bg">
    <div class="container">
        <div class="section-title d-flex justify-content-between align-items-end">
            <h2 class="sectTitle font-weight-semibold mb-0">{{__('home.used')}}
                <span>{{trans_choice('common.cars',0)}}</span>
            </h2>
...
<div class="cars-parts-accessories my-md-5 my-4">
    <div class="container">
        <div class="section-title d-flex justify-content-between align-items-end">
            <h2 class="sectTitle font-weight-semibold mb-0"><span>{{trans_choice('common.cars',0)}}</span>
                {{__('home.parts_accessories')}}
            </h2>
        </div>
...
<div class="cars-parts-accessories pb-md-5 pt-md-5 sects-bg pt-4 pb-4">
    <div class="container">
        <div class="section-title d-flex justify-content-between align-items-end">
            <h2 class="sectTitle font-weight-semibold mb-0"><span>{{__('home.offered')}}</span> {{__('home.services')}}
            </h2>
        </div>
