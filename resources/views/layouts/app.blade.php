...
<head>
    ...
    <meta name="keywords" content="{{ __('common.keywords') }}">
    <meta name="description" content="{{ config('app.name', $GeneralSetting->title) }}  – {{ __('common.meta_description') }}">
...
<body>
                    ...
                    <div class="col-12 text-right  topbar-links">
                        <ul class="d-inline-block list-unstyled mb-0">
                            ...
                            <li class="dropdown list-inline-item logOut-item">
                                <a href="{{ route('signin') }}">{{ __('auth.login_link') }}<em class="fa fa-sign-in"></em></a>
                            </li>
                            <li class="dropdown list-inline-item logOut-item">
                                <a href="{{ route('signup') }}">{{__('auth.signup_link')}}<em class="fa fa-sign-out"></em></a>
                            </li>
                            @endguest
                            @auth('customer')
                            @php
                        ...
                        <div class="header-btn text-right mr-3 d-md-none">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-top-border cstm-dropdown-menu">
                                    <a href="{{ url('user/post-car-ad') }}" class="dropdown-item">{{ __('common.sell') }} {{ trans_choice('common.cars', 1) }}</a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('findusedcars') }}" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            <h5 class="mb-0 font-weight-semibold">{{ __('header.find_used_cars') }}
                                            </h5>
                                    ...
                                    <a href="{{route('simple.search')}}/list/isf_featured" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            <h5 class="mb-0 font-weight-semibold">{{ __('header.featured_used_cars') }}
                                            </h5>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('findautoparts') }}" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            <h5 class="mb-0 font-weight-semibold">{{ __('common.find') }}
                                                {{ __('header.autoparts') }}
                                            </h5>
                                            <p class="mb-0">{{ __('header.browse_over_options') }}</p>
                                        </div>
                                    ...
                                    <a href="{{ route('autoparts.sell') }}" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            <h5 class="mb-0 font-weight-semibold">{{ __('common.sell') }}
                                                {{ __('header.autoparts') }}
                                            </h5>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="{{ route('services.sell') }}" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            <h5 class="mb-0 font-weight-semibold">{{ __('header.sell_car_services') }}</h5>
                                        </div>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <a href="{{ route('terms-of-service') }}" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            <h5 class="mb-0 font-weight-semibold">{{ __('header.terms_condition') }}
                                            </h5>
                                        </div>
                                    </a>
                                    <a href="{{ route('useful-information') }}" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            <h5 class="mb-0 font-weight-semibold">{{ __('header.useful_information') }}
                                            </h5>
                                        </div>
                                    </a>
                                    <a href="{{ route('faqs') }}" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            <h5 class="mb-0 font-weight-semibold">{{ __('header.faqs') }}</h5>
                                        </div>
                                    </a>
                                </div>
                            </li>
                ...
                <div class="col-xl-auto col-lg-auto col-md-3 col-sm-2 header-btn text-right d-none d-md-block">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-top-border cstm-dropdown-menu" style="top: 37px;">
                            <a href="{{ url('user/post-car-ad') }}" class="dropdown-item">{{ __('common.sell') }}
                                {{ trans_choice('common.cars', 1) }}</a>
                            <a href="{{ route('sparepartads') }}" class="dropdown-item">{{ __('common.sell') }}
                                {{ __('header.autoparts') }}</a>
                            @if(@Auth::guard('customer')->user()->customer_role == 'business')
                            <a href="{{ route('offerservices') }}" class="dropdown-item">{{ __('header.offer_service') }}</a>
                            @endif
                        </div>
        ...
        <div class="container">
            <div class="justify-content-between row">
                <div class="col-lg-6 col-md-6 col-12 address-col">
                    <h5 class="font-weight-semibold text-uppercase mb-3">{{ __('common.find') }} {{ __('footer.us') }}:
                    </h5>
                    <ul class="list-unstyled">
                        <li class="d-flex"><em class="fa fa-phone-square"></em> <strong>{{ __('footer.call') }}
                                {{ __('footer.us') }} {{$GeneralSetting->phone_number}}</strong></li>
            ...
            <div class="footer-copyright text-center">
                ...
                <ul class="list-unstyled mb-0">
                    ...
                    <li class="list-inline-item"><a href="{{ route('privacy-policy') }}">{{ __('footer.privacy') }}</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <script async defer type="text/javascript" id="cookieinfo" src="//cookieinfoscript.com/js/cookieinfo.min.js" data-bg="#0072BB" data-fg="#FFFFFF" data-link="#FFFFFF" data-cookie="CarishTCforCookies" data-text-align="left" data-close-text="{{ __('common.i_agree') }}" data-divlinkbg="#67B500" data-linkmsg="{{ __('footer.privacy') }}" data-moreinfo="https://carish.ee/privacy-policy" data-message="{{ __('common.cookies_msg') }}"></script>
