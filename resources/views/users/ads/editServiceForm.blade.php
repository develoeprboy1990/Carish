                ...
                <div class="col-lg-8 col-12">
                  <div class="align-items-center form-group mb-sm-4 mb-3 row">
                    ...
                    <div class="col-md-6 col-sm-7">
                      ...
                      <input type="text" name="title" class="form-control" placeholder="{{__('spareparts.product_name')}}" data-parsley-error-message="Please select Service Name" data-parsley-required="true" data-parsley-trigger="change" value="{{@$service_title->title}}" id="title">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                     ...
                     -->
                            ...
                            <div class="col-md-6 col-sm-12 car-info-list-col car-list-active second-last-record services-sub-catg-col" style="">
                              <h6 class="post-ad-modal-title d-flex align-items-center mb-4" class="post-ad-modal-title"><em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em> {{__('common.sub_category')}}</h6>
                              <div class="post-modal-list">
