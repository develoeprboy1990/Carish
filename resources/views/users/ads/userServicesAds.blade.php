    ...
    <div class="tab-content profile-tab-content">
      ...
      <div class="tab-pane active" id="profile-tab1">
        ...
        <div class="alert alert-success alert-dismissible">
          ...
          <strong>{{__('common.success')}}</strong> {{__('common.service_updated_successfully')}}
        </div>
        @endif
              ...
              <div class="tab-pane active" id="ad-tab3">
                <div class="align-items-center d-flex justify-content-between mb-md-3 mb-2">
                  <div class="display-ad-title">
                    <h6 class="mb-0 font-weight-normal">{{__('ads.displaying')}} <span id="ads_count">{{@$servicesAdsCount->count()}}</span> {{__('ads.ad_listing')}}</h6>
                  </div>
                  <div class="display-ad-status">
                    <select name="" id="ads_selector" class="form-control ads_selector form-control-sm">
                      <option value="1">{{__('ads.active')}} ({{@$services->count()}})</option>
                      <option value="0" {{@$find == 'created' ? 'selected' : ''}}>{{__('ads.Pending')}} ({{@$pending_ads->count()}})
                      <option value="2">{{__('ads.removed')}} ({{@$removed_ads->count()}})</option>
                    </select>
                  </div>
                </div>
                  ...
                  <div class="ads-listing-rows filtered_ads">
                    ...
                    <div class="row p-3 mx-0">
                      ...
                      <div class="col-lg-9 col-sm-8 col-8 pl-md-0 pl-sm-3 pl-0 pr-0 ads-listing-text">
                        ...
                        <p class="ads-views mb-0"><em class="fa fa-eye"></em> {{@$service->views}} {{__('ads.views')}}</p>
                        @if($service->status == 1)
                        <p class="ads-views mb-0" style="color:#005e9b;"><strong>{{__('ads.active_until')}}</strong> {{$service->active_until != null ? $service->active_until : 'N.A'}}</p>
                        @endif
                      </div>
                        ...
                        <div class="row align-items-sm-center">
                          <div class="col-lg-7 col-md-8 col-sm-8 mb-0 editProfile actionbtn ">
                            <ul class="list-unstyled mb-0">
                              <li class="list-inline-item"><a target="" href="{{url('user/edit-service-form/'.@$service->id)}}" class="border d-inline-block px-sm-3 px-2 py-1 rounded">{{__('ads.edit')}} <em class=" ml-1 fa fa-pencil"></em></a></li>

                              <li class="list-inline-item"><a href="" class="border d-inline-block px-sm-3 px-2 py-1 rounded remove-ad" data-id="{{$service->id}}">{{__('ads.remove')}} <em class="ml-1 fa fa-trash"></em></a></li>

                              {{-- <li class="list-inline-item"><a href="#" class="border d-inline-block px-sm-3 px-2 py-1 rounded">{{__('ads.inactive')}} <em class="ml-1 fa fa-refresh"></em></a></li> --}}
                            </ul>
                          </div>
                          <div class="col-lg-5 col-md-4 col-sm-4 pt-3 pt-sm-0 featuredAd text-sm-right">
                            ...
                            <a href="javascript:void(0)" data-id="{{@$service->id}}" class="make_it_featured" data-toggle="modal" data-target="#featureModal"><em class="fa fa-star"></em> {{__('ads.feature_this_ad')}}</a>
                    ...
                    @else
                    <div class="row p-3 mx-0">
                      <h5>{{__('common.no_services_founds')}}</h5>
                    </div>
                    @endif
                  </div>
                </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Feature Ad</h5>
        ...
        <form class="featured_request_form">
          ...
          <div class="modal-body">
            ...
            <div class="input-group" id="car_data" style="border: none;margin-top: 40px;margin-left: 30%;">
              <span style="background-color: white;width: 22%;border-top-left-radius: 5px;border-bottom-left-radius: 5px;border: 1px solid #aaa;border-right: none;padding-left: 5px;line-height: 2;font-weight: 600;">{{__('ads.feature_this_ad_for')}} </span>
          ...
          <div class="modal-footer" style="justify-content: center;border-top: none;">
            <button type="button" class="btn btn-danger" data-dismiss="modal" style="background-color: #eeefff;border: 1px solid #ccc;color: black;">{{__('common.exit')}}</button>
