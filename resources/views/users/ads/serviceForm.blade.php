@extends('layouts.app')
@section('title') {{ __('header.post_an_offer_service_ad') }} @endsection
@section('content')
  @push('styles') 
    <style type="text/css">
      label.error {
  ...
  <div class="container pt-2">
   ...
   <div class="alert alert-danger alert-dismissable print-error-message" style="display:none">
    ...
    <div class="row ml-0 mr-0 post-an-ad-row">
      ...
      <h2 class="border-bottom mx-md-n4 mx-n3 pb-3 px-md-4 px-3 mb-sm-5 mb-4 themecolor">{{__('services.post_an_offer_service')}}</h2>
      ...
      <div class="post-an-ad-sects">
        <h4 class="mx-md-n4 mx-n3 px-md-4 px-3 mb-sm-4 mb-3 font-weight-bold">{{__('services.offer_services_information')}}</h4>
        <div class="vehicleInformation">
          ...
          <div class="col-lg-8 col-12">
            <div class="align-items-center form-group mb-sm-4 mb-3 row">
              ...
              <div class="col-md-6 col-sm-7">
                ...
                <input type="text" name="title" class="form-control" placeholder="{{__('common.title')}}" data-parsley-error-message="Please select Product Name" data-parsley-required="true" data-parsley-trigger="change" autocomplete="off" id="title">
            ...
            <div class="align-items-center form-group mb-sm-4 mb-3 row">
              <div class="col-lg-6 col-md-4 col-sm-3 mb-1 text-sm-right">
                <label class="mb-0">{{__('common.service_type')}}<sup class="text-danger">*</sup></label>
              </div>
              <div class="col-md-6 col-sm-7">
                <input type="text" class="form-control" id="categories" autocomplete="off"   placeholder="{{__('common.category')}}/{{__('common.sub_category')}}" data-toggle="modal" name="spare_categories" data-target="#category-subcategory" data-parsley-error-message="Please Provide Service Info" data-parsley-required="true" data-parsley-trigger="change" >
                ...
                <div class="modal-content overflow-hidden">
                  <div class="modal-body overflow-hidden pt-0">
                    <div class="row car-list-row">
                      ...
                      <div class="col-md-4 col-sm-12 car-info-list-col car-list-active second-last-record services-sub-catg-col"  style="display: none">
                        <h6 class="post-ad-modal-title d-flex align-items-center mb-4" class="post-ad-modal-title">
                          <em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em>{{__('common.sub_category')}}
                        </h6>
                        <div class="post-modal-list">
                      ...
                      <div class="col-md-4 col-sm-12 car-info-list-col version-list-col d-none last-record">
                        <h6 class="post-ad-modal-title d-flex align-items-center mb-4"><em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em> {{__('common.detail')}}</h6>
                        <div class="post-modal-list">
                    ...
                    <div class="mb-2 mt-4 post-modal-btn text-center"><!--  onclick="displayCategory(this)" -->
                      <a href="#" class="btn themebtn1 disabled" data-dismiss="modal" id="done" >{{__('ads.done')}}</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="align-items-center form-group mb-sm-4 mb-3 row">
              <div class="col-lg-6 col-md-4 col-sm-3 mb-1 text-sm-right">
                <label class="mb-0">{{__('common.company_name')}}<sup class="text-danger">*</sup></label>
              </div>
              <div class="col-md-6 col-sm-7">
                <input type="text" class="form-control" value="{{@$customer->customer_company}}" readonly="true" placeholder="{{__('common.company_name')}}">
              </div>
            </div>
            <div class="align-items-center form-group mb-sm-4 mb-3 row">
              <div class="col-lg-6 col-md-4 col-sm-3 mb-1 text-sm-right">
                <label class="mb-0">{{__('common.address')}}<sup class="text-danger">*</sup></label>
              </div>
              <div class="col-md-6 col-sm-7">
                <!-- <input type="text" class="form-control" placeholder="Address"> -->
                <input type="text" class="form-control" value="{{@$customer->customer_default_address}}" readonly="true" name="address" placeholder="{{__('common.address')}}"  data-parsley-error-message="Address Name" data-parsley-required="true" data-parsley-trigger="change">

              </div>
            </div>
            <div class="align-items-center form-group mb-sm-4 mb-3 row">
              <div class="col-lg-6 col-md-4 col-sm-3 mb-1 text-sm-right">
                <label class="mb-0">{{__('common.registration_number')}}<sup class="text-danger">*</sup></label>
              </div>
              <div class="col-md-6 col-sm-7">
                <input type="text" class="form-control" value="{{@$customer->customer_registeration}}" readonly="true" placeholder="{{__('common.registration_number')}}">
              </div>
            </div>
            <div class="align-items-center form-group mb-sm-4 mb-3 row">
              <div class="col-lg-6 col-md-4 col-sm-3 mb-1 text-sm-right">
                <label class="mb-0">{{__('common.vat')}}</label>
              </div>
              <div class="col-md-6 col-sm-7">
                <input type="text" class="form-control" value="{{@$customer->customer_vat}}" readonly="true" placeholder="{{__('common.vat')}}">
              </div>
            </div>
            <div class="align-items-center form-group mb-sm-4 mb-3 row">
              <div class="col-lg-6 col-md-4 col-sm-3 mb-1 text-sm-right">
                <label class="mb-0">{{__('ads.phone')}}<sup class="text-danger">*</sup></label>
              </div>
              <div class="col-md-6 col-sm-7">
            ...
            <div class="align-items-center form-group mb-sm-4 mb-3 row">
              <div class="col-lg-6 col-md-4 col-sm-3 mb-1 text-sm-right">
                <label class="mb-0">{{__('common.website')}}</label>
              </div>
              <div class="col-md-6 col-sm-7">
                <!-- <input type="text" class="form-control" placeholder="Website"> -->
                <input type="text" class="form-control" value="{{@$customer->website}}" readonly="true" placeholder="{{__('common.website')}}" name="website"  data-parsley-error-message="Website Name" data-parsley-required="true" data-parsley-trigger="change">
          ...
          <div class="col-md-4 col-sm-3 text-sm-right">
            <label class="mb-0 control-label">{{__('common.working_hours')}}<sup class="text-danger">*</sup></label>
          </div>
          ...
          <div class="col-md-4 text-md-right">
            <label class="mb-0">{{__('spareparts.ad_description')}}<sup class="text-danger">*</sup></label>
          </div>
          <div class="col-lg-6 col-md-8 col-12">
            <p id="description_error" class="m-0"></p>
              <textarea id="description" class="form-control" rows="5" placeholder="{{__('spareparts.describe_your_product')}}" name="description" data-parsley-error-message="Description" data-parsley-required="true" data-parsley-trigger="change">{{@$service_description->description}}</textarea>
            <div class="about-message-field mt-1">
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLabel">{{__('services.post_an_offer_service')}}</h2>
   ...
   {{-- UploadHBR --}}
    ...
    $(document).ready(function(){
      ...
      $("#myForm").validate({
        ...
        spare_categories: "{{__('common.please_select_services')}}",
