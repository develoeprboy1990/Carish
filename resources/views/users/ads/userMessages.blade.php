        ...
        <div class="bg-white">
          <div class="table-responsive">
            <table class="table table-striped" style="margin-bottom:0px;">
              ...
              <thead>                
                <tr>
                  <th class="border-bottom">{{ __('common.subject') }}</th>
                  <th>
                    <form action="{{route('search-messages')}}" method="GET" name="" class="pull-right">
                      <div class="input-group messages-search border mx-auto">
                        <input id="searchmsg" type="text" name="title" class="form-control border-0 search_chat" placeholder="{{ __('common.search') }}">
              ...
              <thead>                
                <tr>
                  <th colspan="3" style="text-align: center;"><h3>{{ __('common.no_messages') }}</h3></th>
                </tr>
              </thead>
            @endif
            </table>
