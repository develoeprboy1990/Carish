          ...
          <div class="row ad-tab-row">
                ...
                <div class="bg-white border p-3">
                   <ul class="nav nav-tabs nav-pills d-block text-capitalize sidebar-pills payment-tabs">
                    <li class="nav-item">
                      ...
                      </figure> <span>{{__('common.add_balance')}}</span></a>
                    </li>
                    <li class="nav-item">
                      ...
                      </figure> <span>{{__('common.balance_log')}}</span></a>
                    </li>
                    <li class="nav-item">
                      ...
                      </figure> <span>{{__('common.invoice_settings')}}</span></a>
                    </li>
                  </ul>
                </div>
              </div>
              <div class="col-lg-9 col-md-8 mt-md-0 mt-4 pl-md-0 pl-lg-3 payment-tab-desc">
               ...
               <div class="tab-pane active" id="payment-tab1"> 
                <div class="bg-white border px-lg-4 px-3 pt-3 pb-4">
                  <h4 class="mb-3">{{__('common.add_balance')}}</h4>
                  <form class="add-balance-form mt-4 pt-md-2" method="post">
                    {{csrf_field()}}
                    <div class="row justify-content-between align-items-end">
                      <div class="col-lg-6 col-sm-7 col-12">
                        <label class="font-weight-semibold">{{__('common.current_balance')}} <strong>
                        ...
                        <input type="text" class="form-control" placeholder="{{__('common.add_amount')}}" name="amount" required="true">
                      </div> 
                      <div class="col-lg-4 col-sm-5  col-12 mt-sm-0 mt-2 text-sm-right">
                        <input type="submit" name="Submit" value="{{__('common.add_balance')}}" class="btn themebtn1 save-btn">
                      </div>
                    </div>
                  </form>
                </div>
                  ...
                  <div class="border p-2">
                   <div class=" row form-row">
                    ...
                    <div class="align-items-center bl-from-to col-lg-4 mt-lg-0 mt-2 d-flex filterBtn text-md-left text-right">
                      <a href="#" class="applyfilter btn themebtn1 d-none">{{__('common.apply_filter')}}</a>
                      <a href="javascript:void(0)" class="resetfilter btn">{{__('common.reset_filter')}}</a>
                    </div>
                  </div>
                </div>
              ...
              <div class="tab-pane" id="payment-tab3"> 
                <div class="bg-white border px-lg-4 px-3 pt-3 pb-4">
                  <div class="row">
                    <div class="col-6">
                      <h4>{{__('common.invoice_settings')}}</h4>                      
                    </div>   
                    <div class="col-6">
                       <!-- <input type="button" name="invoice_sample" value="Download Sample Invoice" class="btn themebtn1 download_invoice_sample"> -->
                        <div class="backto-dashboard text-right mb-md-3 mb-2">
                          <a href="javascript:void(0)" class="font-weight-semibold themecolor download_invoice_sample"><em class="fa fa-download"></em> {{__('common.download_sample_invoice')}}</a>
                      </div>
                    </div>   
                  </div>
                  <form class="invoice-setting-form mt-md-4 mt-3">
                    ...
                    <div class="row form-group mb-md-4 align-items-center">
                      <div class="text-sm-right col-lg-3 col-md-4 col-sm-4 col-12">
                        <label class="mb-md-0 mb-1">{{__('common.invoice_name')}}</label>
                      </div>
                       <div class="col-lg-5 col-md-6 col-sm-7 col-12">
                        <input type="text" class="form-control" name="invoice_name" placeholder="{{__('common.invoice_name')}}" value="{{@$invoice_setting->invoice_name}}">
                      </div>
                    </div> 
                    <div class="row form-group mb-md-4 align-items-center">
                      <div class="text-sm-right col-lg-3 col-md-4 col-sm-4 col-12">
                        <label class="mb-md-0 mb-1">{{__('common.address')}}</label>
                      </div>
                       <div class="col-lg-5 col-md-6 col-sm-7 col-12">
                        <input type="text" class="form-control" name="address" placeholder="{{__('common.address')}}" value="{{@$invoice_setting->address}}">
                      </div>
                    </div> 
                    <div class="row form-group mb-md-4 align-items-center">
                      <div class="text-sm-right col-lg-3 col-md-4 col-sm-4 col-12">
                        <label class="mb-md-0 mb-1">{{__('common.contact_person')}}</label>
                      </div>
                       <div class="col-lg-5 col-md-6 col-sm-7 col-12">
                        <input type="text" class="form-control" name="contact_person" placeholder="{{__('common.contact_person')}}" value="{{@$invoice_setting->contact_person}}">
                      </div>
                    </div> 
                    <div class="row form-group mb-sm-4">
                       <div class="col-lg-2 offset-lg-3 offset-sm-4 col-md-8 col-sm-8 col-12">
                        <input type="submit" name="Submit" value="{{__('search.save')}}" class="btn themebtn1">
                      </div>
      ...
      $.ajaxSetup({
       ...
       $.ajax({
          ...
          $('.export-quot-form')[0].submit();
            ...
            $('.save-btn').val('{{ __('common.add_balance') }}');
            // $('.save-btn').attr('disabled', true);
