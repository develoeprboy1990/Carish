@extends('layouts.app')
@section('title') {{ __('header.post_a_car_ad') }} @endsection
@section('content')
@push('styles')
<style>
    ...
    <div class="container pt-2">
        ...
        <div class="row ml-0 mr-0 post-an-ad-row mb-4">
            <div class="col-12 bg-white p-md-4 p-3 pb-sm-5 pb-4">
                <h2 class="border-bottom mx-md-n4 mx-n3 pb-3 px-md-4 px-3 mb-sm-5 mb-4 themecolor">{{__('ads.post_an_ad')}}
                </h2>
                    ...
                    <div class="vehicleInformation">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-12">
                                ...
                                <div class="align-items-center form-group mb-sm-4 mb-3 row">
                                    ...
                                    <div class="col-md-6 col-sm-7">
                                        <input type="text" class="form-control" id="car_info" autocomplete="off" placeholder="{{__('common.make_model_year_version')}}" value="{{old('car_info')}}" data-toggle="modal" name="car_info" data-target="#postedcarinfo" data-parsley-error-message="{{__('common.please_provide_car_info')}}" data-parsley-required="true" data-parsley-trigger="change">
                                ...
                                <div class="form-group mb-4 row">
                                    ...
                                    <div class="col-md-6 col-sm-7">
                                        <input class="form-control" type="number" value="{{old('price')}}" pattern="[0-9]" placeholder="{{__('common.price')}}" id="price" name="price" data-parsley-error-message="Please Enter valid price" data-parsley-required="true" data-parsley-trigger="change">
                        ...
                        <div class="form-group mb-4 row">
                            ...
                            <div class="col-lg-6 col-md-8 col-12">
                                ...
                                @php
                                $description = __('ads.inspection_isvalid_untill')
                                @endphp
                                        ...
                                        <div class="upload-note mt-0 mb-2">
                                            <span>
                                                ...
                                                <p class="m-0" style="margin-left: 100px !important;position: relative;top: -20px;color: #999;">
                                                    ({{__('common.maxlimit_5_mb_per_image')}})</p>
                                            </span>
                                        </div>
            ...
            <div class="modal-body overflow-hidden pt-0">
                <div class="row car-list-row" id="make_years">
                    <div class="col-md-3 col-sm-12 car-info-list-col make-list-col car-list-active"  >
                        <h6 class="post-ad-modal-title d-flex align-items-center mb-4">{{__('common.make')}}<br><span id="make_title_selected"></span></h6>
                    ...
                    <div class="col-md-3 col-sm-12 car-info-list-col modal-year-col" style="display: none">
                        <h6 class="post-ad-modal-title d-flex align-items-center mb-4" class="post-ad-modal-title"><em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2 go-to-models"></em>{{__('common.modal')}}
                            {{__('common.year')}}<span id="year_selected"></span>
                        </h6>
                        <div class="post-modal-list">
                    ...
                    <div class="col-md-3 col-sm-12 car-info-list-col version-list-col" style="display: none">
                        <h6 class="post-ad-modal-title d-flex align-items-center mb-4">
                            <em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2 go-to-models-years"></em>{{__('common.version')}}</h6>
                        <div class="post-modal-list">
                ...
                <div class="mb-2 mt-4 post-modal-btn text-center">
                    <a href="#" class="btn disabled themebtn1" data-dismiss="modal">{{__('ads.done')}}</a>
                </div>
            </div>
        </div>
    </div>
...
$(document).ready(function() {
        ...
        $.ajax({
                ...
                success: function(data) { 
                    ...
                    if (data['status'] == 'error') {
                        ...
                        html +=
                            ...
                            data['message'] + '</h6>';
                        $(".post-modal-btn").html(
                            '<a href="#" id="modal_closed" class="btn  themebtn1" data-dismiss="modal">{{__("ads.close")}}</a> '
                        );
                ...
                error: function(xhr, ajaxOptions, thrownError) {
                    if (xhr.status == 404 || xhr.status == 500) {
                        html =
                            '<h6 style="padding-top:50px" class="d-flex align-items-center mb-4"><em class="d-md-none fa fa-arrow-circle-left gobackIcon mr-2"></em>No record found in our database.</h6>';
                        $(".post-modal-btn").html('<a href="#" class="btn  themebtn1" data-dismiss="modal">{{__("ads.close")}}</a>');
                        $(".carnumber-error").html('<strong>Error! </strong>No record found in our database.');
                        $('#carnumber-error').show();
                        $("#myForm").show();
                        $("#overlay").fadeOut(300);
                        clearFormInput();
    ...
    $('.show_more_suggestions').on('click', function() {
        ...
        if (check == true) {
            // alert(check);
            $('.show_more_suggestions').text('{{__("common.show_less")}}');
        } else {
