...
<div class="internal-page-content mt-4 pt-md-5 pt-4 sects-bg">
              ...
              <ul class="nav nav-tabs nav-pills d-block text-capitalize sidebar-pills my-save-ad-tabs">
                <li class="nav-item">
                  <a class="nav-link active d-flex" data-toggle="tab" href="#save-ad-tab1">
                    ...
                    </figure> <span>{{__('common.car')}}</span>
                  </a>
                </li>
                <li class="nav-item">
                  <a class="nav-link d-flex" data-toggle="tab" href="#save-ad-tab2">
                    ...
                    </figure> <span>{{__('common.parts')}}</span>
                  </a>
                </li>
              </ul>
            </div>
          ...
          <div class="col-lg-9 col-md-8 mt-md-0 mt-4 pl-md-0 pl-lg-3 ad-tab-desc">
            <div class="tab-content">
              <div class="tab-pane active" id="save-ad-tab1">
                <div class="align-items-center d-flex justify-content-between mb-md-3 mb-2">
                  <div class="display-ad-title">
                    <h6 class="mb-0 font-weight-normal">{{__('ads.displaying')}} {{@$saveAds != null ? @$saveAds->count():'0'}} {{__('ads.ad_listing')}}</h6>
                  </div>
                </div>
                        ...
                        <div class="row align-items-sm-center">
                          <div class="col-lg-7 col-md-8 col-sm-8 mb-0 actionbtn ">
                            <ul class="list-unstyled mb-0">
                              <li class="list-inline-item"><a href="javascript:void(0)" class="border border-danger d-inline-block px-sm-3 px-2 py-1 rounded text-danger" data-id="{{$s_ads->id}}" id="remove-ad"> {{__('ads.remove_ad')}}<em class="ml-1 fa fa-trash"></em></a></li>
              ...
              <div class="tab-pane" id="save-ad-tab2">
                <div class="align-items-center d-flex justify-content-between mb-md-3 mb-2">
                  <div class="display-ad-title">
                    <h6 class="mb-0 font-weight-normal">{{__('ads.displaying')}} {{@$saveParts != null ? @$saveParts->count():'0'}} {{__('ads.ad_listing')}}</h6>
                  </div>
                </div>
                    ...
                    <div class="col-lg-3 col-sm-4 col-4 pl-0 mb-0 ">
                      ...
                      <div class="col-12 px-0 mt-3">
                        <div class="row align-items-sm-center">
                          <div class="col-lg-7 col-md-8 col-sm-8 mb-0 actionbtn ">
                            <ul class="list-unstyled mb-0">
                              <li class="list-inline-item"><a href="javascript:void(0)" class="border border-danger d-inline-block px-sm-3 px-2 py-1 rounded text-danger" data-id="{{$part_ads->id}}" id="remove-partAd"> {{__('ads.remove_ad')}}<em class="ml-1 fa fa-trash"></em></a></li>
                  ...
                  <div class="ads-listing-rows">
                    <div class="row p-3 mx-0">
                      <div class="col-12 px-0 mt-3">
                        <div class="row align-items-sm-center">
                          <div class="col-lg-12 col-md-8 col-sm-8 mb-0 ">
                            <h5>{{__('search.no_record_found')}}</h5>
                          </div>
                        </div>
                      </div>
                    </div>
  ...
  <script type="text/javascript">
    $('#remove-ad').on('click', function() {
      ...
      swal({
          title: "Alert!",
          text: "{{__('ads.you_sure')}} {{__('ads.you_sure_toremove')}}",
          type: "info",
