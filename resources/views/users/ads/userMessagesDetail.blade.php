      ...
      <div class="tab-pane active" id="profile-tab4">
        <div class="bg-white">
          <div class="table-responsive">
            ...
            <div class="messages-col_{{$result['chat_id']}}">
              <div class="border-bottom mx-auto px-2 py-3 row">
                ...
                <div class="col-md-4 col-sm-4 col-12 message-backto text-right">
                  <a target="" href="{{route('my-messages')}}" class="font-weight-semibold themecolor"><em class="fa fa-chevron-circle-left"></em> {{ __('profile.back_to_dashboard') }}</a>
                </div>
              </div>
              <div class="p-4">
                  ...
                  <form method="post" id="send-message">
                    ...
                    <div class="message-area mt-5 pt-3">
                      <div class="form-group">
                        <textarea id="description" name="messageArea" rows="5" class="form-control mb-1" placeholder="{{ __('ads.your_message') }}" required></textarea>

                        <div class="about-message-field mt-1">
                          <span class="font-weight-semibold">{{__('spareparts.remaining_characters')}} <span id="description_count">250</span></span>
                        </div>
            ...
            @endforeach
            @else
            <h3 class="p-2">{{ __('common.no_messages') }}</h3>
            @endif
          </div>
        </div>
        <!-- Tab 4 ends here -->
