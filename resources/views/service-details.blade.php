                ...
                <nav aria-label="breadcrumb" class="breadcrumb-menu">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a target=""
                                href="{{url('/find-car-services')}}">{{ __('common.offer_services_in_estonia') }}</a></li>
                        <li class="breadcrumb-item"><a target=""
                        ...
                        <div class="d-flex justify-content-between sellerinfo">
                            <div class="sellerinfo-left">
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    @else
                                      <li><strong>{{ __('common.address') }}:</strong> <a href="javascript:void(0)">{{$service_ads->customer->city->name}}</a></li>
                                    @endif 
                                </ul>
                            </div>
                            <div class="sellerinfo-right pl-3 text-right">
                                ...
                                <p class="incltext mb-0">{{(@$service_ads->vat != null) ?  __('common.incl_vat') : ''}}
                                </p>
                                <p class="themecolor2 font-weight-semibold mb-0 negotiable">
                                    {{(@$service_ads->neg != null) ? __('common.negotiable') : ''}}</p>
                            </div>
                        </div>
                        <div
                                ...
                                <a href="javascript:void(0)" class="btn themebtn3 toggle_number">
                                    <span class="d-flex align-items-center">
                                        ...
                                        <span class="half_number text-left">
                                            {{substr(@$service_ads->get_customer->customers_telephone,0,7)}}....<br>{{ __('ads.show_number') }}
                                        </span>
            ...
            <div class="col-12 mt-lg-4 p-md-4 p-3 notifyForm detail-page-notifyform" style=" background: #E4E4E4;">
                <div class="row p-sm-2 align-items-center">
                    <div class="col-lg-5 col-12 mb-lg-0 mb-3">
                        ...
                        <p class="mb-0">{{ __('ads.set_your_alerts_for') }} <strong>{{@$p_caty}}</strong>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            <textarea class="form-control customer_message" name="customer_message"  id="customer_message"  cols="8"
                                ...
                                id="ex3">{{ __('ads.hi_i_am_interested_in_your_car') }} <b>{{@$p_caty !== null ? @$p_caty : ''}}</b> {{ __('ads.advertised_on') }} <a href="https://carish.ee/">Cairsh</a>. {{ __('ads.please_let_me_know_if_it_still_available') }}<br>
              Thanks.</textarea>
                        </div>
                    </div>
